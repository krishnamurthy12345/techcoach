...
// import { ToastContainer, toast } from 'react-toastify';
// import { getMemberSharedDecisions, mailToDecisionCirclePostComment, postComment, getComments, deleteComment } from './Networkk_Call';
// import { Card, CardContent, Typography, Grid, Avatar, CircularProgress, MenuItem, Select, FormControl, InputLabel } from '@mui/material';
// import axios from 'axios';
// import { AiFillEdit } from "react-icons/ai";
// import { MdOutlineDeleteForever } from "react-icons/md";
// import './GetGroup.css';
...
//     const [newComment, setNewComment] = useState('');
//     const [buttonLoading, setButtonLoading] = useState({});
//     const [selectedMemberId, setSelectedMemberId] = useState(''); // Add state for selected member
...
//             if (!selectedMemberId) {
//                 return toast.error('Please select a member to post the comment');
//             }

//             await postComment(newComment, groupId, decisionId, selectedMemberId);
//             setNewComment('');
//             toast.success('Comment posted successfully');
...
//     const handlemailToPostComment = async (decisionId, email, withEmail = false) => {
//         try {
//             setButtonLoading(prevState => ({ ...prevState, [decisionId + '_email']: true }));
...
//             await handlePostComment(decisionId);

//             if (withEmail) {
//                 const decisionDetails = decisions.find(d => d.decision_id === decisionId).decisionDetails;
//                 const responseToPostComment = await mailToDecisionCirclePostComment(decisionDetails, selectedMemberId, newComment, email);
//                 toast.success('Email sent successfully');
//                 console.log('Response from email API:', responseToPostComment);
//             }
...
//                                                                 {comment.displayname} | {comment.email} | 
//                                                                 {comment.created_at === comment.updated_at
//                                                                     ? <span>{formatDistanceToNow(parseISO(comment.created_at))} ago</span>
//                                                                     : <span>updated {formatDistanceToNow(parseISO(comment.updated_at))} ago</span>
//                                                                 }
//                                                             </Typography>
//                                                         </div>
//                                                     </div>
...
//                                         >
//                                             {buttonLoading[decision.decision_id] ? <CircularProgress size={24} /> : 'Post'}
//                                         </button>
//                                         <button
//                                             onClick={() => handlemailToPostComment(decision.decision_id, decision.shared_by, true)}
//                                             className='comment-btn'
//                                             disabled={buttonLoading[decision.decision_id + '_email']}
//                                         >
//                                             {buttonLoading[decision.decision_id + '_email'] ? <CircularProgress size={24} /> : 'Post & Mail'}
//                                         </button>
//                                     </div>
//                                 </CardContent>
//                             </Card>
...
//                     ))
//                 ) : (
//                     <p>No shared decisions available</p>
//                 )}
//             </Grid>
//         </div>
//     );
