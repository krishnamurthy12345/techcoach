...
//         decisions.forEach(decision => {
//             const decisionDetails = decision?.decisionDetails;
//             if (decisionDetails && (!showPending || !decisionDetails.decision_taken_date)) {
//                 const user = decisionDetails.userDetails;
//                 if (user && user.email && !emails.has(user.email)) {
//                     emails.add(user.email);
//                     users.push(user);
//                 }
//             }
...
//     const handleAutocompleteChange = (event) => {
//         setAutocompleteValue(event.target.value);
//         const selected = getUniqueUsers(sharedDecisionCircles).find(user => `${user.displayname} (${user.email})` === event.target.value);
//         setSelectedUser(selected);
//     };
...
//     return (
//         <Box p={3}>
//             <h4>Decision Circle Decisions:</h4>
//             {isLoading ? (
...
//                                 >
//                                     <option value="">Sort by Name</option>
//                                     {getUniqueUsers(sharedDecisionCircles, showPending).map((user, index) => (
//                                         <option key={index} value={`${user.displayname} (${user.email})`}>
//                                             {user.displayname} ({user.email})
//                                         </option>
//                                     ))}
...
//                                                             disabled={
//                                                                 !commentTexts[item.decisionDetails?.decision_id] ||
//                                                                 buttonLoading[item.decisionDetails?.decision_id + "_email"]
//                                                             }
//                                                         >
//                                                             {buttonLoading[item.decisionDetails?.decision_id + "_email"] ? (
//                                                                 <CircularProgress size={24} />
